...
int printMenu(float kilometers, float aerolineasFee, float latamFee) {
	...
	printf("3. Calcular todos los costos para cada aerolínea:\na) Tarjeta de débito (descuento 10%%)\n"
...
/**
* \brief Sets predetermined values for kilometers, Aerolíneas Argentinas fee and LATAM Airlines fee
* \param float predetermined kilometers
* \param float predetermined Aerolíneas Argentinas fee
* \param float predetermined Latam Fee
* \param float pointer to kilometers
* \param float pointer to Aerolíneas Argentinas fee
